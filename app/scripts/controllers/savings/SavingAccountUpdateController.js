(function (module) {
    mifosX.controllers = _.extend(module, {
        SavingAccountUpdateController: function (scope, resourceFactory, location, routeParams, dateFilter) {
            scope.products = [];
            scope.fieldOfficers = [];
            scope.formData = {};
    ...
    mifosX.ng.application.controller('SavingAccountUpdateController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', mifosX.controllers.EditSavingAccountController]).run(function ($log) {
        $log.info("SavingAccountUpdateController initialized");
    });
}(mifosX.controllers || {}));
